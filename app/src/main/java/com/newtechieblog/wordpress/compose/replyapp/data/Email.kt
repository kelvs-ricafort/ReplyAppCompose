package com.newtechieblog.wordpress.compose.replyapp.data
...
data class Email(
    ...
    val id: Long,
    /** Sender of the email **/
    val sender: com.newtechieblog.wordpress.compose.replyapp.data.Account,
    /** Recipient(s) of the email **/
    val recipients: List<com.newtechieblog.wordpress.compose.replyapp.data.Account> = emptyList(),
    /** Title of the email **/
